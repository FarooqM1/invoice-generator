              ...
              <div className="p-4" id="print">
                ...
                <div className="mt-6">
                  <div className="mb-4 grid grid-cols-2">
                    ...
                    <span className="font-bold">Invoice From:</span>
                    <span>{invoiceInfo.invoiceFrom}</span>
                    ...
                    <span>{invoiceInfo.paymentterm}</span>
                    <span className="font-bold">Due Date:</span>
                    <span>{invoiceInfo.duedate}</span>
                    <span className="font-bold">PO Number:</span>
                    <span>{invoiceInfo.ponumber}</span>
                    <span className="font-bold">Notes:</span>
                    <span>{invoiceInfo.notes}</span>
                    <span className="font-bold">Terms:</span>
                    <span>{invoiceInfo.terms}</span>
                  </div>
